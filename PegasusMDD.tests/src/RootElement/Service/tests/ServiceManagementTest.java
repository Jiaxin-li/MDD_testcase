...
public class ServiceManagementTest extends TestCase {
	 ...
	 * @generated
	 */
	protected ServiceManagement fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(ServiceManagementTest.class);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(ServiceManagement fixture) {
	 ...
	 * @generated
	 */
	protected ServiceManagement getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ServiceFactory.eINSTANCE.createServiceManagement());
	}
	...
	/**
	 * Tests the '{@link RootElement.Service.IService#getService(int) <em>Get Service</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
